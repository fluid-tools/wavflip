...
export const isSelectModeActiveAtom = atom((get) => get(selectionModeAtom));
...
export const selectedItemsCountAtom = atom(
  (get) => get(selectedItemsAtom).size
);
...
export const enterSelectionModeAtom = atom(null, (_, set) => {
...
export const bulkDeleteSelectedAtom = atom(null, (get) => {
