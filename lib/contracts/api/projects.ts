import { z } from 'zod';
import { ProjectWithTracksSchema, ProjectRowSchema, TrackVersionSchema, TrackWithVersionsSchema } from '@/lib/contracts/project';
...
const ProjectRowApiSchema = ProjectRowSchema.extend({
  createdAt: ZDate,
  updatedAt: ZDate,
});
