...
export const requireProjectOwnership = (record: Project, userId: string): void => {
...
export const setProjectImageKey = async (projectId: string, imageKey: string): Promise<void> => {
  await db
    .update(project)
